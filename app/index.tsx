...
export default function SingIn() {
    ...
    return (
        <Animated.View entering={FadeIn.delay(350).duration(400)} style={[{ paddingHorizontal: '7%', justifyContent: 'center', flex: 1 }]} >
            <Loading refresh={isPending} loading={false} />
            <View style={{ flex: 1 }} />
            <ScrollView>
                ...
                <Button
                    ...
                    onPress={() => Alert.alert('Reinicio de contraseña', 'Comunicate con tu titular para realizar el proceso de reinicio de contraseña.')}
