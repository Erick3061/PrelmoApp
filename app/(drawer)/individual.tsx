...
const Individual = () => {
    ...
    // const pages: { title: string, key: filterEvents, nameIcon: string, color: string }[] = report === 'ap-ci'
    //     ?
    //     [
    ...
    return (
        <>
            {/* <View style={{ marginVertical: 10, paddingHorizontal: 10 }}>
                <Text variant='titleSmall'><View style={{ width: 3, height: Platform.OS === 'ios' ? 13 : 11 }} /> {account.Nombre}</Text>
                <Text variant='labelSmall' ><View style={{ width: 3, height: 10 }} /> Entre las fechas {start} a {end}</Text>
            </View>
            {
                (!filter)
                    ?
