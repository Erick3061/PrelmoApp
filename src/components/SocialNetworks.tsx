...
export const SocialNetworks = () => {
    ...
    return (
        <View style={{ display: 'flex', flexWrap: 'wrap', flexDirection: 'row', paddingVertical: 5, justifyContent: 'space-evenly', width: '100%', paddingHorizontal: 10 }}>
            <IconButton size={size} iconColor={iconColor} icon='web' onPress={() => Linking.openURL('https://pem-sa.com')} />
            <IconButton size={size} iconColor={iconColor} icon='facebook' onPress={() => Linking.openURL('fb://page/557351134421255')
            ...
            <IconButton size={size} iconColor={iconColor} icon='twitter' onPress={() => Linking.openURL('https://twitter.com/pemsa_85')} />
            <IconButton size={size} iconColor={iconColor} icon='instagram' onPress={() => Linking.openURL('https://instagram.com/pemsa_85/')} />
        </View>
    )
}
